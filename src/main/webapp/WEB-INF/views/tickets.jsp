...
<body>
<header><div><p class="eyebrow">NORTHSTAR IT OPERATIONS</p><h1>Helpdesk workspace</h1></div><div class="account"><span class="user"><%= session.getAttribute("displayName") %> - <%= session.getAttribute("role") %></span><form method="post" action="${pageContext.request.contextPath}/logout"><button type="submit">Log out</button></form></div></header>
<main>
